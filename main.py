...
def config_components(win):
    ...
    btn_start = tk.Button(labelframe, text=const.BTN_TEXT_START, height=1, width=30, padx=0, pady=0, command= lambda:btn_start_click(lbl_run))
    btn_start.grid(column=1, row=0, padx=12, pady=5, sticky=tk.W)
    
    #botao para parar o mouse
    btn_start = tk.Button(labelframe, text=const.BTN_TEXT_STOP, height=1, width=30, padx=0, pady=0, command= lambda:btn_stop_click(lbl_run))
    btn_start.grid(column=1, row=1, padx=12, pady=5, sticky=tk.W)
